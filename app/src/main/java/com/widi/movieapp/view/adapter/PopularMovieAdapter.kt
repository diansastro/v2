...
class PopularMovieAdapter(var list: List<PopularMovieData>): BaseQuickAdapter<PopularMovieData, BaseViewHolder>(R.layout.item_movie_by_genre, list) {
    override fun convert(helper: BaseViewHolder?, item: PopularMovieData?) {
