...
class MovieListAdapter(var list: List<MovieData>): BaseQuickAdapter<MovieData, BaseViewHolder>(R.layout.item_movie_by_genre, list) {
    override fun convert(helper: BaseViewHolder?, item: MovieData?) {
